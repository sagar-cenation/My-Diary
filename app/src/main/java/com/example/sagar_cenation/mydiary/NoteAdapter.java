...
public class NoteAdapter extends ArrayAdapter<Note>{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(note != null) {
            TextView title = (TextView) convertView.findViewById(R.id.list_node_title);
            TextView date = (TextView) convertView.findViewById(R.id.list_node_date);
            TextView content = (TextView) convertView.findViewById(R.id.list_node_content);
